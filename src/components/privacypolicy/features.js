  ...
  <Section id="Privacy Policy">
    <StyledContainer>
      ...
      <SectionTitle>Customer Privacy Policy</SectionTitle>
        ...
        <FeatureItem>
          <FeatureText>
          Loophole respects your privacy. All information you give us is held with the utmost care and security. We at Loophole are committed to protecting your privacy. If you’re visiting our websites, using our services, working with any of our teams, meeting us at events, or applying for a role with us, this privacy policy sets out what data we collect, and how we use it. It also describes your rights regarding our use of your data.
        ...
        <FeatureItem>
          ...
          <FeatureText>
          Pursuant to the General Data Protection Regulation (“GDPR“), personal data means any information 
        ...
        <FeatureTitle>CHANGES TO THIS PRIVACY POLICY</FeatureTitle>
          <FeatureText>
          BY USING THIS WEBSITE AND/OR SERVICES, YOU AGREE THAT YOU AS THE DATA SUBJECT CONSENT TO THIS PRIVACY POLICY. YOU AGREE THAT LOOPHOLE.CLOUD MAY MAKE CHANGES TO THIS PRIVACY POLICY AT ANY TIME WITHOUT ANY GIVEN NOTICE AT ITS DISCRETION.
          </FeatureText>
        </FeatureItem>
        ...
        <FeatureTitle>Contact Us</FeatureTitle>
          <FeatureText>
          If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us at: <a href = "mailto: loophole@main.dev">loophole@main.dev</a>.
          </FeatureText>
        </FeatureItem>
