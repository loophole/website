...
Loophole does not log or store any data transmitted through your tunneled connections. Loophole does log some information about the connections which are used for debugging purposes and metrics like the name of the tunnel and the duration of connections.
