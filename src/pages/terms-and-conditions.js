...
const TermsAndConditions = () => {
  ...
  return (
    <Layout title="Terms and Conditions" description={siteConfig.tagline}>
      <header className="hero">
        <div className="container">
          <h1 className="hero__subtitle">Terms and Conditions</h1>
        </div>
      </header>
      <main>
        <section>
          <div className="container">
            ...
            <h4>Agreement</h4>
            <p>
              These Terms of Service (the "Terms") cover your use of the
              services Loophole provides, including the Loophole.cloud website
              (the "Site"), the Loophole API, the Loophole tunneling service,
              the Loophole client software, and any other software or services
              offered by Loophole in connection with any of the above services
              (the "Loophole Services" or the "Services"). "Loophole" means the
              owner and operator of the Loophole Services which distributes the
              Loophole software and services.
              <br />
            ...
            <p>
              ...
              account, your passwords, and auth tokens; and you are fully
              ...
              security or unauthorized use of your account. Loophole will not be
              liable for any acts or omissions by you, including any damages of
              any kind incurred as a result of such acts or omissions. The
              personal information you provide to Loophole for the purpose of
              creating and maintaining your account is governed by the Loophole
              Privacy Policy.
            </p>
            <h4>Trademarks</h4>
            <p>
              Loophole, and any other product or service name or slogan
              contained in the Site are trademarks of Loophole and its suppliers
              or licensors (unless otherwise indicated), and may not be copied,
              imitated or used, in whole or in part, without the prior written
              permission of Loophole or the applicable trademark holder. The
              Service is protected by copyright, trademark, and other laws of
              both Germany and foreign countries. Run multiple tunnels
              simultaneously with a single loophole client.
            </p>
            <h4>Links To Other Web Sites</h4>
            <p>
              Loophole may use data provided by third parties in the content on
              the Site and in the Services and may provide links to web pages
              and content of third parties (collectively the "Third Party
              Content") as a service to those interested in this information.
              Loophole does not monitor or have any control over any Third Party
              Content or third party web sites. You acknowledge and agree that
              Loophole shall not be responsible or liable, directly or
            ...
            <p>
              ...
              Loophole the fees for each Service you purchase or use in
              ...
              monthly, annual, or another agreed-upon basis, as set forth in the
              pricing and payment terms presented to you for such Service, in
              advance of providing the Services. The Services may be interrupted
              on accounts that reach 5 days past due. Fees paid by you are
              non-refundable, except as provided in these Terms or when required
              by law. Loophole is not responsible for any additional bank fees,
              interest charges, finance charges, overdraft charges, or other
              fees resulting from charges billed by Loophole. Currency exchange
              settlements will be based on agreements between you and the
              provider of your credit card.
            </p>
            <h4>Fee Changes</h4>
            <p>
              ...
              Billing Cycle. Loophole will provide you with reasonable prior
            ...
            <p>
              In no event shall Loophole, nor its directors, employees,
            ...
            <p>
              You represent and warrant that your use of the Loophole website
              and Services will be in strict accordance with the Loophole
              Privacy Policy, with this Agreement and with all applicable laws
              ...
              areas, regarding online conduct and acceptable content, and
              including all applicable laws regarding the transmission of
              technical data exported from the Germany or the country in which
              you reside).
            </p>
            ...
            <p>
              ...
              WITH THE SERVICES, OR (D) CONTENT MADE AVAILABLE OVER YOUR
              TUNNELS, INCLUDING ANY LIABILITY OR EXPENSE ARISING FROM ANY
              CLAIMS, LOSSES, DAMAGES (ACTUAL AND CONSEQUENTIAL), SUITS,
              JUDGMENTS, LITIGATION COSTS AND ATTORNEYS' FEES, OF EVERY KIND AND
              NATURE. IN SUCH A CASE, Loophole WILL PROVIDE YOU WITH WRITTEN
              NOTICE OF SUCH CLAIM, SUIT OR ACTION.
            </p>
            <h4>Notice</h4>
            <p>
              You agree that Loophole may provide you with notices, including
              those regarding changes to the Terms, by email, regular mail, or
              postings on the Loophole website.
            </p>
            <h4>Entire Agreement</h4>
            <p>
              The Terms (including any policies, guidelines or amendments that
              may be presented to you from time to time) constitute the entire
              agreement between you and Loophole and govern your use of the
              Loophole Services, superseding any prior agreements between you
              and Loophole for the use of the Loophole Services.
            </p>
            <h4>Waiver and Severability of Terms</h4>
            <p>
              The failure of Loophole to exercise or enforce any right or
              ...
              ct.vision, and the other provisions of the Terms remain in full
              force and effect.
            </p>
            <h4>Governing Law</h4>
            <p>
            ...
            <p>
              ...
              provide at least seven (7) days' notice before the changes take
              effect, during which period of time you may reject the changes by
              terminating your account. What constitutes a material change will
              be determined at our sole discretion. By continuing to access or
              use our Service after any revisions become effective, you agree to
              be bound by the revised terms. If you do not agree to the new
              terms, you are no longer authorized to use the Service.We may
              terminate or suspend access to the Services immediately, without
              prior notice or liability (other than refunding pre-paid fees to
              the extent we terminate based on no action or omission on your
              part), for any reason whatsoever, including, but not limited to,
              if you breach any of the Terms. All provisions of the Terms which,
              by their nature, should survive termination shall survive
              termination, including, without limitation, ownership provisions,
              warranty disclaimers, indemnifications, and limitations of
              liability.
            </p>
            <h4>Contact Us</h4>
            <p>
